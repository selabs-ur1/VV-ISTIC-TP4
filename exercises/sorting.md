...
Lien vers l'implémentation : [Sorting](../code/sorting/src/main/java/fr/istic/vv/Sorting.java) / [SortingTest](../code/sorting/src/test/java/fr/istic/vv/SortingTest.java)
